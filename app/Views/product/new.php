        ...
        <div class="col-12">
            ...
            <form action="/product" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="example-product-name" aria-describedby="emailHelp" placeholder="Enter product name" required name="name">
                </div>

                <div class="form-group">
                    <label for="example-product-stock">Stock</label>
                    <input type="number" min="1" class="form-control" id="example-product-stock" aria-describedby="emailHelp" placeholder="Enter product stock" required name="stock">
                </div>

                <div class="form-group">
                    <label for="example-product-price">Price</label>
                    <input type="number" min="1" class="form-control" id="example-product-price" aria-describedby="emailHelp" placeholder="Enter product price" required name="price">
                </div>
