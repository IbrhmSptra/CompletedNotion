        ...
        <div class="col-12">
            ...
            <form action="/product/<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="example-product-name" aria-describedby="emailHelp" placeholder="Enter product name" required name="name" value="<?= $data['name'] ?>">
                </div>

                <div class="form-group">
                    <label for="example-product-stock">Stock</label>
                    <input type="number" min="1" class="form-control" id="example-product-stock" aria-describedby="emailHelp" placeholder="Enter product stock" required name="stock" value="<?= $data['stock'] ?>">
                </div>

                <div class="form-group">
                    <label for="example-product-price">Price</label>
                    <input type="number" min="1" class="form-control" id="example-product-price" aria-describedby="emailHelp" placeholder="Enter product price" required name="price" value="<?= $data['price'] ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="example-product-photo" aria-describedby="photoHelp" name="photo" value="<?= $data['photo'] ?>">
                </div>
